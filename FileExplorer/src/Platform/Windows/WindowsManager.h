...
namespace FEOS::Files
{
    ...
    public:
        ...
        bool DeleteFile_(const Path& filePath) const override;
        bool DeleteFolder(const Path& folderPath) const override;
    ...
    private:
        ...
        File ParseWindowsFile(const WIN32_FIND_DATA& filedata) const;
