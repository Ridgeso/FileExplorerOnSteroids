...
#include "FileExplorer/Core/Log.h"
    ...
    #define FEOS_EXPLORER_ASSERT(...) FEOS_ASSERT_GET_IMPL(__VA_ARGS__, FEOS_ASSERT_IMPL_WITH_MSG, FEOS_ASSERT_IMPL_NO_MSG)(_LOG_, __VA_ARGS__)
    #define FEOS_ASSERT(...) FEOS_ASSERT_GET_IMPL(__VA_ARGS__, FEOS_ASSERT_IMPL_WITH_MSG, FEOS_ASSERT_IMPL_NO_MSG)(_, __VA_ARGS__)
#else
